...
namespace Helixbase.Feature.Akamai.EdgeGridAuth
{
    ...
    public class EdgeGridV1Signer : IRequestSigner
    {
        ...
        private readonly static string _proxy = Sitecore.Configuration.Settings.GetSetting("Akamai.Proxy");
        ...
        public WebRequest Sign(WebRequest request, ClientCredential credential, Stream uploadStream = null)
        {
            ...
            WebProxy proxy = new WebProxy(_proxy, true);// 代理类
            request.Proxy = proxy;  //设置网关
            return request;
        }
