...
namespace Helixbase.Feature.Sitecron.Jobs.SitecoreJob
{
    public class SitecoreScheduleCommandJob : IJob //Inherit from IJob interface from Quartz
    {
        public void Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                var options = new DefaultJobOptions(job.SitecoreJobName, job.SitecoreJobCategory, job.SitecoreJobSiteName, instance, scheduleItem.CommandItem.InnerItem[SitecronConstants.FieldNames.Method], new object[] { scheduleItem.Items, scheduleItem.CommandItem, scheduleItem });
