...
{/// <summary>
 ...
 /// </summary>
	public class ConfigurationBuilder: IConfigurationBuilder
	{
		...
		public  XConnectClientConfiguration GetClientConfiguration(string collectionHost, string searchHost, string configHost, string thumbprint)
		{
		...
		/// <returns></returns>
		public  IEnumerable<IHttpClientHandlerModifier> GetReferenceDataHandlers(string thumbprint)
		{
