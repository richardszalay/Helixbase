...
namespace Helixbase.Foundation.XConnect.Repositories
{
    ...
    {
        private static readonly ILog _logger = log4net.LogManager.GetLogger("Sitecore.Diagnostics.XConnect");
        private static ILog log;
        public static ILog Log
        {
            get
            {
                return log ?? (log = LogManager.GetLogger("Sitecore.Diagnostics.XConnect"));
            }
        }
